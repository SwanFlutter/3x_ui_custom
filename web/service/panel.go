...
const (
	panelUpdaterURL      = "https://raw.githubusercontent.com/SwanFlutter/3x-ui/main/update.sh"
...
func fetchLatestPanelVersion() (string, error) {
	...
	resp, err := client.Get("https://api.github.com/repos/SwanFlutter/3x-ui/releases/latest")
	if err != nil {
		return "", err
	}
	defer resp.Body.Close()

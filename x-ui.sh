...
update() {
    ...
    bash <(curl -Ls https://raw.githubusercontent.com/SwanFlutter/3x_ui_custom/main/update.sh)
    if [[ $? == 0 ]]; then
...
update_menu() {
    ...
    curl -fLRo /usr/bin/x-ui https://raw.githubusercontent.com/SwanFlutter/3x_ui_custom/main/x-ui.sh
...
legacy_version() {
    ...
    install_command="bash <(curl -Ls "https://raw.githubusercontent.com/SwanFlutter/3x_ui_custom/v$tag_version/install.sh") v$tag_version"
...
uninstall() {
    ...
    echo -e "${green}bash <(curl -Ls https://raw.githubusercontent.com/SwanFlutter/3x_ui_custom/main/install.sh)${plain}"
    echo ""
...
update_shell() {
    curl -fLRo /usr/bin/x-ui -z /usr/bin/x-ui https://raw.githubusercontent.com/SwanFlutter/3x_ui_custom/main/x-ui.sh
    if [[ $? != 0 ]]; then
        echo ""
...
show_menu() {
    echo -e "
╔────────────────────────────────────────────────╗
│   ${green}3x_ui_custom Panel Management Script${plain}                │

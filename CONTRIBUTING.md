...
```bash
git clone https://github.com/SwanFlutter/3x-ui.git
cd 3x-ui
...
- Bug reports and feature requests: [GitHub Issues](https://github.com/SwanFlutter/3x-ui/issues)
- General questions and ideas: [GitHub Discussions](https://github.com/SwanFlutter/3x-ui/discussions)
